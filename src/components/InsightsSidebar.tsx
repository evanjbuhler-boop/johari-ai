...
export default function InsightsSidebar({
  ...
  return (
    <>
      {/* Sidebar */}
      <aside
        className={`fixed left-0 top-28 h-[calc(100vh-7rem)] overflow-hidden bg-gradient-to-br from-primary/30 via-secondary/20 to-accent/25 backdrop-blur-2xl border-r border-primary/20 transition-all duration-500 z-10 shadow-2xl ${
