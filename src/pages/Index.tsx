    ...
    if (urlParams.get('preview') === 'results') {
      ...
      const mockResults: CheckInResults = {
        ...
        whatsHappening: {
          ...
          fullExplanation: "This pattern is classic high-functioning anxiety. You've likely succeeded by setting extremely high standards, but now those same standards are becoming a source of stress rather than motivation. The fear of falling short is creating a self-fulfilling prophecy—your anxiety about performance is affecting your actual performance.",
          citations: [
            { author: "Brené Brown", year: 2010, title: "The Gifts of Imperfection" }
          ]
        },
        quotes: [
